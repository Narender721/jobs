...
//                .headers(auth -> auth.setBearerAuth("eyJraWQiOiIwNWU0ZjJkOS05MDY4LTQ5MGYtYTBmYy1jMTg4Y2NlODY5ZDciLCJhbGciOiJSUzI1NiJ9..SWXJdG4MxyTseO0vGDFGzyvxaJYDL_UMw1WLOrdzN_UOOk-_mYOqvTxxikJ09l85YDwESp4nhtfCyJ2tWhaE-OoKcXGD-T2DMTI_xaJqBkb8-QxAa3Or3X0tPmvND_nFhJ6nAek7nTNhG1ly_Sz5fA95qLMc1X4nOFJ_UPxcz0Ctkw8a0-ix6kto-8_EgJbILI2ejgL5JiuR4nX6UEXm_2Mym8fMp5UoPxy3AhU55Fx1Z-OUZCS3PB8czA0HxDGsVuYKAj-sKu7scLtAH4RYyqbqMo9cJhFYAgfgyHrO2hTjR93VjxYyAjK5vEMK1iKfByQ5KD4SHfRhHHlsa0vMaw"))
                .headers(auth -> auth.setBearerAuth(getBearer()))
...
//        return "afaes";
        ...
        Mono<AuthorizationModel> aaa = WebClient.create().get()
                .uri("https://api-ppe.tesco.com/tescolocation/v4/locations?fields=lifecycle&limit=100&offset=200")
                .retrieve()
                .bodyToMono(AuthorizationModel.class);

        AuthorizationModel model = aaa.share().block();
        assert model != null;
        String x = model.getAccess_token();
